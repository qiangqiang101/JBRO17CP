...
Public Class frmShop
        ...
        Try
            If InvokeRequired Then
                BeginInvoke(DirectCast(Sub()
                                           ...
                                           Do While d.Read
                                               item = New shopItem With {.Value = d("ItemName"), .CurrencyMethod = CInt(d("ItemCurrency")), .Price = d("ItemPrice"), .Remaining = d("ItemRemain"), .Desciption = d("ItemDesc"), .ItemID = d("ItemID")}
    ...
    Private Sub ItemClick(sender As shopItem, e As EventArgs)
        Try
            Dim newForm As frmProductBrowser = New frmProductBrowser
            newForm.pID = sender.ItemID
            newForm.pbImage.Image = sender.Icon
            newForm.lblName.Text = sender.Value
            newForm.Text = String.Format("产品: {0}", sender.Value)
            newForm.lblPrice.Text = sender.priceTag.Text
            newForm.currencyMethod = sender.CurrencyMethod
            newForm.price = sender.Price
            newForm.lblRemain.Text = sender.Remaining
            newForm.lblDesc.Text = sender.Desciption
