    ...
    Private Sub btn_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Save.Click
        Try
            ...
            xConn.connectUser("Update CPSetting Set " &
                              ...
                              "[RBPrimaryJifen] = '" & txtRBPrimaryJifen.Text & "', " &
                              "[RBSecondaryJifen] = '" & txtRBSecondaryJifen.Text & "', " &
                              "[RBAdvanceJifen] = '" & txtRBAdvanceJifen.Text & "', " &
                              "[AddStatGold] = '" & txt_AddStatGold.Text & "', " &
                              "[AddStatJifen] = '" & txtAddStatJifen.Text & "', " &
                              "[ChgSchoolGold] = '" & txt_ChgSchoolGold.Text & "', " &
                              "[ChgSchoolJifen] = '" & txtChgSchoolJifen.Text & "', " &
                              "[ClearPKGold] = '" & txt_ClearPKGold.Text & "', " &
                              "[ClearPKJifen] = '" & txtClearPKJifen.Text & "', " &
                              "[ChgNameGold] = '" & txt_ChgNameGold.Text & "', " &
                              "[ChgNameJifen] = '" & txtChgNameJifen.Text & "', " &
    ...
    Private Sub frmAdminSetting_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Do While d.Read
                ...
                txtRBPrimaryJifen.Text = d("RBPrimaryJifen")
                txtRBSecondaryJifen.Text = d("RBSecondaryJifen")
                txtRBAdvanceJifen.Text = d("RBAdvanceJifen")
                txt_RebornWait.Text = d("RebornWait")
                txt_AddStatGold.Text = d("AddStatGold")
                txtAddStatJifen.Text = d("AddStatJifen")
                txt_ChgSchoolGold.Text = d("ChgSchoolGold")
                txtChgSchoolJifen.Text = d("ChgSchoolJifen")
                txt_ClearPKGold.Text = d("ClearPKGold")
                txtClearPKJifen.Text = d("ClearPKJifen")
                txt_ChgNameGold.Text = d("ChgNameGold")
                txtChgNameJifen.Text = d("ChgNameJifen")
